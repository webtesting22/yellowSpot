            ...
            <section className="slite-padding">
                ...
                <div className="animated-text-about">
                    <TypeAnimation
                        ...
                        repeat={Infinity}
                    />
                    <p>Where innovation meets visibility – your brand's journey starts here.</p>
                    <div className="slite-padding"></div>
                    <div>
                ...
                <div className="slite-padding"></div>
                <div className="parent-poster-content">
                ...
                <div className="slite-padding"></div>
                <div className="slite-padding"></div>
                <div className="parent-Company-info container" id="parent-company">
                    <Row>
                        <Col lg={8}>
